...
func (q contentTypeQuery) One(exec boil.Executor) (*ContentType, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for content_types")
	}
...
func FindContentType(exec boil.Executor, iD int64, selectCols ...string) (*ContentType, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from content_types")
	}
...
func (o *ContentType) Insert(exec boil.Executor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into content_types")
	}
...
func (o *ContentType) Update(exec boil.Executor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("models: unable to update content_types, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by update for content_types")
	}
...
func (q contentTypeQuery) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	...
	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected for content_types")
	}
...
func (o ContentTypeSlice) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	...
	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected all in update all contentType")
	}
	return rowsAff, nil
}
...
func (o *ContentType) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("models: unable to upsert content_types, could not build update column list")
		}
...
func (o *ContentType) Delete(exec boil.Executor) (int64, error) {
	...
	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by delete for content_types")
	}
...
func (q contentTypeQuery) DeleteAll(exec boil.Executor) (int64, error) {
	...
	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by deleteall for content_types")
	}
...
func ContentTypeExists(exec boil.Executor, iD int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if content_types exists")
	}
