...
func (q contentUnitDerivationQuery) One(exec boil.Executor) (*ContentUnitDerivation, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for content_unit_derivations")
	}
...
func FindContentUnitDerivation(exec boil.Executor, sourceID int64, derivedID int64, selectCols ...string) (*ContentUnitDerivation, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from content_unit_derivations")
	}
...
func (o *ContentUnitDerivation) Insert(exec boil.Executor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into content_unit_derivations")
	}
...
func (o *ContentUnitDerivation) Update(exec boil.Executor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("models: unable to update content_unit_derivations, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by update for content_unit_derivations")
	}
...
func (q contentUnitDerivationQuery) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	...
	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected for content_unit_derivations")
	}
...
func (o ContentUnitDerivationSlice) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	...
	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected all in update all contentUnitDerivation")
	}
	return rowsAff, nil
}
...
func (o *ContentUnitDerivation) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("models: unable to upsert content_unit_derivations, could not build update column list")
		}
...
func (o *ContentUnitDerivation) Delete(exec boil.Executor) (int64, error) {
	...
	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by delete for content_unit_derivations")
	}
...
func (q contentUnitDerivationQuery) DeleteAll(exec boil.Executor) (int64, error) {
	...
	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by deleteall for content_unit_derivations")
	}
...
func ContentUnitDerivationExists(exec boil.Executor, sourceID int64, derivedID int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if content_unit_derivations exists")
	}
