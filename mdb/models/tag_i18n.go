...
func (o *TagI18n) Update(exec boil.Executor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("models: unable to update tag_i18n, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by update for tag_i18n")
	}
...
func (q tagI18nQuery) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	...
	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected for tag_i18n")
	}
...
func (o TagI18nSlice) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	...
	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected all in update all tagI18n")
	}
	return rowsAff, nil
}
...
func (o *TagI18n) Delete(exec boil.Executor) (int64, error) {
	...
	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by delete for tag_i18n")
	}
...
func (q tagI18nQuery) DeleteAll(exec boil.Executor) (int64, error) {
	...
	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by deleteall for tag_i18n")
	}
