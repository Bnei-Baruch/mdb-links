...
func (q twitterTweetQuery) One(exec boil.Executor) (*TwitterTweet, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for twitter_tweets")
	}
...
func (q twitterTweetQuery) All(exec boil.Executor) (TwitterTweetSlice, error) {
	...
	err := q.Bind(nil, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to TwitterTweet slice")
	}
...
func (q twitterTweetQuery) Count(exec boil.Executor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count twitter_tweets rows")
	}
...
func (q twitterTweetQuery) Exists(exec boil.Executor) (bool, error) {
	...
	err := q.Query.QueryRow(exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if twitter_tweets exists")
	}
...
func FindTwitterTweet(exec boil.Executor, iD int64, selectCols ...string) (*TwitterTweet, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from twitter_tweets")
	}
...
func (o *TwitterTweet) Insert(exec boil.Executor, columns boil.Columns) error {
	if o == nil {
		return errors.New("models: no twitter_tweets provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into twitter_tweets")
	}
...
func (o *TwitterTweet) Update(exec boil.Executor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("models: unable to update twitter_tweets, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update twitter_tweets row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by update for twitter_tweets")
	}
...
func (q twitterTweetQuery) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update all for twitter_tweets")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected for twitter_tweets")
	}
...
func (o TwitterTweetSlice) UpdateAll(exec boil.Executor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update all in twitterTweet slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected all in update all twitterTweet")
	}
	return rowsAff, nil
}
...
func (o *TwitterTweet) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("models: no twitter_tweets provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("models: unable to upsert twitter_tweets, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert twitter_tweets")
	}
...
func (o *TwitterTweet) Delete(exec boil.Executor) (int64, error) {
	if o == nil {
		return 0, errors.New("models: no TwitterTweet provided for delete")
	}
	...
	result, err := exec.Exec(sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete from twitter_tweets")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by delete for twitter_tweets")
	}
...
func (q twitterTweetQuery) DeleteAll(exec boil.Executor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("models: no twitterTweetQuery provided for delete all")
	}
	...
	result, err := q.Query.Exec(exec)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete all from twitter_tweets")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by deleteall for twitter_tweets")
	}
...
func (o TwitterTweetSlice) DeleteAll(exec boil.Executor) (int64, error) {
	...
	result, err := exec.Exec(sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete all from twitterTweet slice")
	}
...
func (o *TwitterTweetSlice) ReloadAll(exec boil.Executor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in TwitterTweetSlice")
	}
...
func TwitterTweetExists(exec boil.Executor, iD int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if twitter_tweets exists")
	}
